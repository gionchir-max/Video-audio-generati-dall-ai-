#!/usr/bin/env node
// Auto-mode: genera N clip berlusconi su meta.ai via CDP del browser MCP
// Stesso flow di _run-frida.mjs, slug = berlusconi
// TOTAL_CLIPS verrà aggiornato dopo aver misurato la durata del VO (ceil(VO/5))
...
const SLUG = "berlusconi";
const TOTAL_CLIPS = 57;
