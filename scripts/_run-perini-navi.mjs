#!/usr/bin/env node
// Auto-mode: genera N clip perini-navi su meta.ai via CDP del browser MCP
// Stesso flow di _run-berlusconi.mjs, slug = perini-navi
// VO durata: 288.48s → 58 clip
...
const SLUG = "perini-navi";
const TOTAL_CLIPS = 58;
